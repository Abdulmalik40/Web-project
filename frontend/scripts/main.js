...
function initEventSearch() {
  ...
  const EVENTS = [
    ...
    { titleKey: 'makkahPage.event1Title', descKey: 'makkahPage.event1Description', cityKey: 'destinations.makkah', cityFallback: 'Makkah', link: 'cities/makkah.html', keywords: ['مكة', 'makkah'] },
    { titleKey: 'makkahPage.event2Title', descKey: 'makkahPage.event2Description', cityKey: 'destinations.makkah', cityFallback: 'Makkah', link: 'cities/makkah.html', keywords: ['مكة','makkah','sky view', 'جولة بانورامية', 'makkah experience'] },
    { titleKey: 'makkahPage.event3Title', descKey: 'makkahPage.event3Description', cityKey: 'destinations.makkah', cityFallback: 'Makkah', link: 'cities/makkah.html', keywords: ['مكة','makkah','hira cultural district', 'حي حراء', 'مكة ترحب بنا'] },
    { titleKey: 'makkahPage.section2Title', descKey: 'makkahPage.section2Para1', cityKey: 'destinations.makkah', cityFallback: 'Makkah', link: 'cities/makkah.html#modern-kingdom', keywords: ['مكة','makkah','المسجد الحرام', 'grand mosque', 'kaaba', 'الكعبة', 'الحرم', 'the holy mosque'] },
    { titleKey: 'makkahPage.section3Title', descKey: 'makkahPage.section3Para1', cityKey: 'destinations.makkah', cityFallback: 'Makkah', link: 'cities/makkah.html#modern-kingdom', keywords: ['مكة','makkah','المشاعر المقدسة', 'sacred sites', 'منى', 'عرفات', 'مزدلفة', 'قطار المشاعر'] },
    { titleKey: 'makkahPage.section1Item3', descKey: 'makkahPage.section1Para3', cityKey: 'destinations.makkah', cityFallback: 'Makkah', link: 'cities/makkah.html#first-state', keywords: ['مكة','makkah','جبل النور', 'hira cave', 'جبل حراء', 'jabal al nour'] },
    { titleKey: 'makkahPage.section1Item4', descKey: 'makkahPage.section2Para1', cityKey: 'destinations.makkah', cityFallback: 'Makkah', link: 'cities/makkah.html#first-state', keywords: ['مكة','makkah','بئر زمزم', 'zamzam well', 'ماء زمزم'] },
    { titleKey: 'makkahPage.section1Item5', descKey: 'makkahPage.section2Para1', cityKey: 'destinations.makkah', cityFallback: 'Makkah', link: 'cities/makkah.html#first-state', keywords: ['مكة','makkah','مجمع الملك عبد العزيز لكسوة الكعبة', 'kiswah', 'kaaba complex'] },
